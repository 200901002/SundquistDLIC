...
public class EFlux{
    ...
    public EFlux(double tw, double rhok, double zk, double ak) {
        //Electric flux of linear antenna using Chebyshev integration.
        this.tw=tw;
        this.rhok=rhok;
        this.zk=zk;
        this.ak=ak;
    ...
    public double getEFlux() {
        return EFlux(tw,rhok,zk,ak);
    }
    
    public double EFlux(double tw, double rhok, double zk, double ak) {
        ...
        return rhok*( -sum1*Math.cos(tr) + sum2*Math.sin(tr) );
    }
